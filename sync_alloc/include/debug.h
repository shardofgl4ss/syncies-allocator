...
extern void
log_to_console(void (*log_and_stream)(const char *format, va_list va_args), const char *str, ...) ATTR_PRIVATE;

/// @brief Prints all important statistics about the arena at any given time.
/// @param arena The arena to print statistics.
void
debug_print_memory_usage(const Arena *restrict arena) ATTR_PROTECTED;
...
extern Debug_VTable ATTR_PRIVATE sync_alloc_log;
