...
#define MAX_ALLOC_POOL_SIZE		65535
#define MAX_ALLOC_HUGE_SIZE		4294967296
#define MAX_POOL_SIZE			MAX_ALLOC_HUGE_SIZE
...
constexpr u16 PD_PFH_DATA_SIZE = (sizeof(Pool_Free_Header_Data) + (ALIGNMENT - 1)) & (u16)~(ALIGNMENT - 1);
...
constexpr u16 MINIMUM_BLOCK_ALLOC = ALIGNMENT + 8 + PD_HEAD_SIZE;
