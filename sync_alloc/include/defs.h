...
#define PUBLIC_ALLOC_API __attribute__((visibility("default")))
...
static constexpr u16 PD_HDL_MATRIX_SIZE = ((PD_HANDLE_SIZE * MAX_TABLE_HNDL_COLS) + PD_TABLE_SIZE) + (ALIGNMENT - 1) & (u16)~(ALIGNMENT - 1);
static constexpr u16 MINIMUM_BLOCK_ALLOC = 8 + PD_HEAD_SIZE;
