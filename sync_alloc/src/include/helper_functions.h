...
helper_destroy(void *restrict mem, const usize bytes) { return munmap(mem, bytes); }
...
[[maybe_unused]] ATTR_INLINE ATTR_PURE inline static void *
helper_return_block_addr(Pool_Header *head) { return (char *)head + PD_HEAD_SIZE; }
...
helper_return_matrix_row(const struct Arena_Handle *restrict hdl)
{
...
[[maybe_unused]] ATTR_INLINE ATTR_PURE inline static u32
helper_return_matrix_col(const struct Arena_Handle *restrict hdl)
{
	return hdl->handle_matrix_index % MAX_TABLE_HNDL_COLS;
}
